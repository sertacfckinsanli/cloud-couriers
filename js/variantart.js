...
export const VARIANTS = {
  ...
  hospital: {
    ...
    pos: { cart: '72% 66%', garland: '50% 18%', mend: '54% 58%', cots: '37% 42%', cabinet: '64% 40%', rack: '36% 68%' },
    fx: { cart: {x:72,y:66,w:12,h:18}, garland: {x:50,y:18,w:66,h:22}, mend: {x:54,y:56,w:16,h:28}, cots: {x:37,y:42,w:40,h:36}, cabinet: {x:64,y:40,w:10,h:40}, rack: {x:36,y:68,w:12,h:32} },
    layered: {
      FW: 2424, FH: 1039, base: 'lay_base.jpg', dirty: 'lay_dirty.jpg',
