...
export const VARIANTS = {
  ...
  hospital: {
    ...
    pos: { cart: '72% 66%', garland: '50% 18%', mend: '54% 58%', cots: '37% 42%', cabinet: '64% 40%', rack: '41% 70%' },
    fx: { cart: {x:72,y:66,w:12,h:18}, garland: {x:50,y:18,w:66,h:22}, mend: {x:54,y:56,w:16,h:28}, cots: {x:37,y:42,w:40,h:36}, cabinet: {x:64,y:40,w:10,h:40}, rack: {x:41,y:70,w:22,h:34} },
    layered: {
      FW: 2424, FH: 1039, base: 'lay_base.jpg', dirty: 'lay_dirty.jpg',
      ...
      sprites: {
        ...
        rack:    { '1': {f:'lay_R1.png',x:816,y:621,w:333}, '2': {f:'lay_R2.png',x:816,y:570,w:443}, '3': {f:'lay_R3.png',x:819,y:608,w:329} },
      },
    },
  },
  observatory: {
    ...
    layered: {
      ...
      sprites: {
        ...
        charts:    { '1': {f:'lay_H1.png',x:730,y:622,w:381}, '2': {f:'lay_H2.png',x:735,y:614,w:378}, '3': {f:'lay_H3.png',x:494,y:557,w:690} },
      },
    },
  },
  office: {
