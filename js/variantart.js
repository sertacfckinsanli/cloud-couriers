...
export const VARIANTS = {
  ...
  hospital: {
    ...
    pos: { cart: '72% 66%', garland: '50% 18%', mend: '54% 58%', cots: '37% 42%', cabinet: '64% 40%', rack: '30% 66%' },
    fx: { cart: {x:72,y:66,w:12,h:18}, garland: {x:50,y:18,w:66,h:22}, mend: {x:54,y:56,w:16,h:28}, cots: {x:37,y:42,w:40,h:36}, cabinet: {x:64,y:40,w:10,h:40}, rack: {x:30,y:66,w:14,h:26} },
    layered: {
      FW: 2424, FH: 1039, base: 'lay_base.jpg', dirty: 'lay_dirty.jpg',
      ...
      sprites: {
        ...
        rack:    { '1': {f:'lay_R1.png',x:600,y:560,w:270}, '2': {f:'lay_R2.png',x:600,y:585,w:270}, '3': {f:'lay_R3.png',x:605,y:560,w:270} },
      },
    },
  },
  office: {
